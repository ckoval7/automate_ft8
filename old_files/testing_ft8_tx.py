...
class usb_tx_bpf(gr.top_block):
    ...
    def __init__(self):
        ...
        self.file_name = file_name = "/home/corey/gnuradio_graphs/wctf_defcon_2019/ft8_qso.conf"
        ...
        self._wav_file_config.read('path+file_name')
        ...
        #self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/corey/gnuradio_graphs/wctf_defcon_2019/ft8_cq.wav', False)
